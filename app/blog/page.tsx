    ...
    <div className="min-h-screen pt-20 sm:pt-24 pb-12 sm:pb-20">
      ...
      <section className="py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-purple-500/30 bg-purple-500/10 mb-4 sm:mb-6">
      ...
      <section className="py-8 sm:py-12 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <motion.div
            ...
            className="relative p-6 sm:p-12 md:p-16 rounded-2xl sm:rounded-3xl border border-purple-500/30 bg-slate-900/50 backdrop-blur-sm text-center"
          >
            {/* Decorative elements */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
              <div className="relative">
                <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-purple-600 to-teal-600 flex items-center justify-center shadow-[0_0_60px_rgba(139,92,246,0.5)]">
            ...
            <div className="mt-4 sm:mt-8">
              ...
              <p className="text-base sm:text-lg text-slate-400 mb-6 sm:mb-8 max-w-lg mx-auto">
              ...
              <div className="grid gap-3 sm:gap-4 mb-6 sm:mb-8">
                {[
                  ...
                  <motion.div
                    ...
                    className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl border border-white/10 bg-white/5 text-left"
                  >
                    <div className="w-2 h-2 rounded-full bg-purple-500 animate-pulse flex-shrink-0" />
                    <div className="flex-1 min-w-0">
                      <div className="text-white font-medium text-sm sm:text-base truncate sm:whitespace-normal">
                        {post.title}
                      </div>
                    ...
                    <span className="px-2 sm:px-3 py-1 rounded-full text-xs font-mono border border-purple-500/30 bg-purple-500/10 text-purple-400 flex-shrink-0">
                      {post.tag}
                    </span>
                  </motion.div>
                ))}
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
            {[
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-white/10 bg-white/5 text-slate-300 font-mono text-xs sm:text-sm hover:border-purple-500/50 hover:bg-purple-500/10 hover:text-purple-300 transition-all cursor-default"
              >
                {topic}
              </motion.span>
            ))}
